...
ax1.plot(inv_w, ((savsi+ssvsi+ sapah+savgr+ssvgr)/st[kvis]-1.0)*av_mod, color="green", lw=2, label="nano")
ax1.plot(inv_w, ((sad+ssd)/st[kvis]-1.0)*av_mod, color='black', lw=2, label=r"$\mu$A")
...
ax2.plot(wpol, spdd, color='black', lw=2, label=r"$\mu$A")
ax2.plot(wpol, spcd,   color='brown', lw=2, label="aC")
ax2.plot(wpol, spsid, color='orange', lw=2, label="Si")
ax2.plot(wpol, sp, color='magenta', lw=3, label="total")
ax2.set_xlim(0.3, 14)
...
ax3.set_xscale('log')
ax3.set_yscale('log')
ax3.fill_between(w_emi, 4e-4, fd, color='lightgray')
ax3.plot(w_emi, fn, color='green', lw=2, label="nano")
ax3.plot(w_emi, fd, color= 'black',  lw=2, label=r"$\mu$A")
ax3.plot(w_emi, fac, color='brown', lw=2, label="aC")
ax3.plot(w_emi, fasi, color='orange', lw=2, label="Si")
ax3.plot(w_emi, f, color='magenta', lw=3, label="total")
ax3.set_xlim(2, 3000)
...
ax4.set_xscale('log')
ax4.set_yscale('log')
ax4.fill_between(w_ep, 1e-5, emip_d * fak_p, color='lightgray')
ax4.plot(w_ep, emip_d * fak_p, color='black',  lw=2,label=r"$\mu$A")
ax4.plot(w_ep, emip_c * fak_p, color='brown', lw=2, label='aC')
ax4.plot(w_ep, emip_si * fak_p, color='orange', lw=2, label='Si')
ax4.plot(w_ep, emip_t * fak_p, color='magenta', lw=3, label='total')
...
plt.tight_layout()
plt.savefig('Example_RedPolEmis_py.png')
plt.show()
